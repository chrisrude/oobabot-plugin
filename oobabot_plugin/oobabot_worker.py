...
DISCORD_BEHAVIOR_CHECKBOX_OPTIONS = [
...
class OobabotWorker:
    ...
    bot: oobabot.Oobabot
    input_handlers: typing.Dict[
        gr.components.IOComponent,
        oobabot_input_handlers.ComponentToSetting,
    ]
    ...
    def save_settings(self, config_file: str):
        if self.is_running():
        ...
        self.reload()
        self.bot.settings.write_to_file(config_file)
    ...
    def get_input_handlers(
        ...
        components_to_settings = [
            oobabot_input_handlers.SimpleComponentToSetting(
                layout.discord_token_textbox,
                settings.discord_settings,
                "discord_token",
            ),
            oobabot_input_handlers.CharacterComponentToSetting(
            ...
            oobabot_input_handlers.ListComponentToSetting(
                layout.wake_words_textbox,
                settings.persona_settings,
                "wakewords",
            ),
            oobabot_input_handlers.ResponseRadioComponentToSetting(
            ...
            oobabot_input_handlers.CheckboxGroupToSetting(
        ...
        self.input_handlers = {c.component: c for c in components_to_settings}
        return self.input_handlers
